...
#ifndef MINIKIN_EMAI_LINE_BREAKER_HELPERS_H
#define MINIKIN_EMAI_LINE_BREAKER_HELPERS_H
...
class EMAILineWidth : public LineWidth {
public:
    EMAILineWidth(float firstWidth, int32_t firstLineCount, float restWidth,
