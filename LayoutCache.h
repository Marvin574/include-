/*
 * Copyright (C) 2018 The Emai Open Source Project
 *
...
public:
    ...
    emai::hash_t hash() const { return mHash; }
    void copyText() {
...
inline emai::hash_t hash_type(const LayoutCacheKey& key) {
    return key.hash();
}
}  // namespace minikin
#endif  // MINIKIN_LAYOUT_CACHE_
